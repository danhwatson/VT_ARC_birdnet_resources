...
BASE_DIR="/projects/birdnet/chemours/data_2024_bn_confbins_segments"
# Define the output base directory
OUTPUT_BASE_DIR="/projects/birdnet/chemours/extracted_comnig"

# Define the species identifier -ex. comnig = Common Nighthawk
SPECIES="comnig"
