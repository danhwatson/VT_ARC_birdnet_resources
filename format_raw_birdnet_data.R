...
# Latest update: 07/15/2024
# Process to analyze birdnet data collected with Wildlife Acoustic recorders (ARUs) from 2024 field season
...
setwd("~/Library/Mobile Documents/com~apple~CloudDocs/documents/data_2024_bn")
